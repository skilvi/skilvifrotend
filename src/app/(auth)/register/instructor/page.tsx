            ...
            <div className="flex items-start gap-3 mt-4">
              <div className="flex items-center h-5">
                <input
                  ...
                  className="w-4 h-4 border border-slate-300 rounded bg-slate-50 focus:ring-3 focus:ring-emerald-300 dark:bg-slate-700/50 dark:border-slate-600 dark:focus:ring-emerald-600 dark:ring-offset-slate-800"
                />
              </div>
              <div className="text-sm">
                <label htmlFor="agreeToTerms" className="font-medium text-slate-700 dark:text-slate-300">
                  I agree to the <a href="https://www.emberquest.in/terms-of-service" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline">Terms of Service</a> and acknowledge the <a href="https://www.emberquest.in/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline">Privacy Policy</a> and <a href="https://www.emberquest.in/acceptable-use-policy" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline">Acceptable Use Policy</a>.
                </label>
